...
export default function CreateProductForm() {
  ...
  return (
    <div className="flex flex-col gap-3">
      <BackButton destination={"/admin/product"} />
      <form onSubmit={handleSubmit} className="flex flex-col w-1/2 px-5">
        {/* Product Name */}
        ...
        <div className="flex flex-col gap-3">
          <h4 className="text-sm text-emerald-700 font-bold mb-1">Product Images</h4>
